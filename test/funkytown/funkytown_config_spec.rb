...
describe "The FunkytownConfig default_config" do
  it "should pick ant correctly based on windows vs unix" do
    ...
    Funkytown::FunkytownConfig.default_config[:ant].should =~ Regexp.new('funkytown\\\\dummy_project\\\\vendor\\\\ant\\\\bin\\\\ant.bat$')

    SYSTEM.stub!(:windows).and_return(false)
    Funkytown::FunkytownConfig.default_config[:ant].should =~ Regexp.new('funkytown/dummy_project/vendor/ant/bin/ant$')
  end
end
